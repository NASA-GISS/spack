...
export MODULEPATH=$MODULEPATH:$SPACK_ROOT/share/spack/modules/linux-centos6-broadwell
...
#     '/opt/scyld/openmpi/4.0.3' --> '/home/eafischer2/om4.0.3'
#unset LD_LIBRARY_PATH
export LD_LIBRARY_PATH=$(echo $LD_LIBRARY_PATH | sed 's@/opt/scyld/openmpi/4.0.3@/home/eafischer2/om4.0.3@g')
export PATH=$(echo $PATH | sed 's@/opt/scyld/openmpi/4.0.3@/home/eafischer2/om4.0.3@g')


# Make sure `ectl setup` (ModelE setup; see modele-control repo) can
# find MPI, and that we can do mpirun when needed.
export PATH=$PATH:/home/eafischer2/om4.0.3/intel/bin/
